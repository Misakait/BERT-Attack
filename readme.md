...
## 实验说明
安装完依赖,比如torch在我的4060上要安装cuda124版本
```
pip install torch torchvision torchaudio --index-url https://download.pytorch.org/whl/cu124
```
运行
```
python bertattack.py --data_path test_set.csv --mlm_path bert-base-chinese --tgt_path my_finetuned_fraud_detection_model --output_dir attack_results.json --use_sim_mat 0 --num_label 2 --start 0 --end 100
```
这里的--mlm_path指定攻击者模型,-tgt_path指定被攻击模型路径,--output_dir指定输出结果路径,--start和--end指定攻击数据集的从几行到几行
...
For your specific CSV file, you can use a command like this (assuming you have a fine-tuned Chinese BERT model):
```
python bertattack.py --data_path path/to/your/data.csv --mlm_path bert-base-chinese --tgt_path path/to/your/finetuned-chinese-bert --output_dir adversarial_examples.json --num_label 2 --use_bpe 1 --k 48 --start 0 --end 1000 --threshold_pred_score 0
```
